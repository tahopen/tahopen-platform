...
/**
 * Implementation of {@link IUnifiedRepositoryWebService} that delegates to an
 * {@link IUnifiedRepository} instance.
 * 
 * @author mlowery
 */
...
public class DefaultUnifiedRepositoryWebService implements IUnifiedRepositoryWebService {
  ...
  @Deprecated
  public List<RepositoryFileDto> getChildrenWithFilterAndHidden(String folderId, String filter,
  ...
  public RepositoryFileTreeDto getTreeFromRequest(final RepositoryRequest repositoryRequest) {
    ...
    // PDI uses this web-service and system folders must be returned to admin
