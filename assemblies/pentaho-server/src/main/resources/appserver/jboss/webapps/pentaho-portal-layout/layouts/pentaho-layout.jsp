...
General Public License for more details. * * Copyright (c) 2002-2017 Hitachi
Vantara.. All rights reserved. --%> <%@ page
import="org.jboss.portal.theme.LayoutConstants,
org.jboss.portal.theme.page.PageResult"%> <%@ page
import="org.jboss.portal.server.PortalConstants"%> <%@ taglib
uri="/WEB-INF/theme/portal-layout.tld" prefix="p" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <% boolean maximized = false; PageResult pageResult =
    (PageResult)request.getAttribute(LayoutConstants.ATTR_PAGE); if
    ("maximized".equals(pageResult.getLayoutState())) { maximized = true; } %>
    <title>2.6.1</title>
    ...
    <script
      ...
      language="javascript"
      src="/pentaho-portal-layout/packed.js"
    ></script>
  </head>
  ...
  <body id="body" onload="PageLoad()">
    ...
    <table
      ...
      cellspacing="0"
      width="100%"
      style="padding: 0; margin: 20px 0px 0px 0px"
    >
      <tr valign="middle">
        <td>
          <div class="portalLogo" width="100%">
            <div
              class="sampleHeader"
              onClick="window.location='/portal/portal/pentaho'"
            >
              <br />Tahopen Business Intelligence Platform <br />Portal
              Demo&nbsp;
            </div>
          </div>
        </td>
    ...
    >
      <tr valign="middle">
        <td width="100%" class="pageMenuContainer">
          <%-- called pnavigation so as not to conflict with region name used by
