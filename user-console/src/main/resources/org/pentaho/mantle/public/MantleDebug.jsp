...
of the GNU Lesser General Public License along with this * program; if not, you
can obtain a copy at http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html * or
from the Free Software Foundation, Inc., * 51 Franklin Street, Fifth Floor,
Boston, MA 02110-1301 USA. * * This program is distributed in the hope that it
will be useful, but WITHOUT ANY WARRANTY; * without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. * See the GNU Lesser
General Public License for more details. * * Copyright (c) 2002-2021 Hitachi
Vantara. All rights reserved. --%>

<!DOCTYPE html>
<%@page import="org.owasp.encoder.Encode" %> <%@page
import="org.pentaho.platform.util.messages.LocaleHelper" %> <%@page
import="java.net.URL" %> <%@page import="java.net.URLClassLoader" %> <%@page
import="java.util.Locale" %> <%@page import="java.util.ResourceBundle" %> <% //
Handle the `locale` request parameter. Locale effectiveLocale =
LocaleHelper.parseLocale( request.getParameter( "locale" ) );
LocaleHelper.setSessionLocaleOverride( effectiveLocale );
LocaleHelper.setThreadLocaleOverride( effectiveLocale ); effectiveLocale =
LocaleHelper.getLocale(); URLClassLoader loader = new URLClassLoader( new URL[]
{ application.getResource( "/mantle/messages/" ) } ); ResourceBundle properties
= ResourceBundle.getBundle( "mantleMessages", effectiveLocale, loader ); %>

<html>
  <head>
    <title>Tahopen User Console</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta
      name="gwt:property"
      content="locale=<%= Encode.forHtmlAttribute(effectiveLocale.toString()) %>"
    />
    <link rel="icon" href="/pentaho-style/favicon.ico" />
    <link
      rel="apple-touch-icon"
      sizes="180x180"
      href="/pentaho-style/apple-touch-icon.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="32x32"
      href="/pentaho-style/favicon-32x32.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="/pentaho-style/favicon-16x16.png"
    />
    <link
      rel="mask-icon"
      href="/pentaho-style/safari-pinned-tab.svg"
      color="#cc0000"
    />
    <link rel="stylesheet" href="mantle/MantleStyle.css" />
    <link
      rel="stylesheet"
      href="content/data-access/resources/gwt/datasourceEditorDialog.css"
    />
...
-->
    ...
    <iframe
      ...
      style="width: 0px; height: 0px; border: 0; display: none"
    ></iframe>
  </body>
