 ...
 * interfaces focuses on describing the *minimal* contract between the Tahopen BI Platform and an Action in the
 * same way that {@link org.pentaho.platform.api.engine.IComponent} describes a similar but more involved contract.
 * <p>
 * The Tahopen BI Platform expects Action objects to be Java bean API compliant with respect to setting inputs,
